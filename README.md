...
Make a GET request
 ...
 ```json
 {
   ...
   "reviews": [
     ...
     "Brilliant 👍 Updated Review: There is no foundation for any negative feedback. 💯 I think many people are having problems as their devices do not have the correct specifications for ultimate performance. Remember you need a device with plenty memory and a good processor.",
